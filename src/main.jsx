...
function App() {
  return <>
    <header className="nav">
      <a className="brand" href="#top" aria-label="Maxfual home">
    ...
    <main id="top">
      <section className="hero">
        <div className="heroText">
          ...
          <p className="lead">A clean demo concept for Maxfual: a South African fuel management brand focused on theft prevention, tank visibility, on-site refuelling, and simple reporting for operators.</p>
          ...
          <p className="researchNote">*Demo built from public research. maxfual.co.za did not resolve during lookup, so copy is intentionally conservative.</p>
        </div>
      ...
      <section id="process" className="split">
        <div><p className="eyebrow"><span></span>How it works</p><h2>From tank to report, make the blind spots visible.</h2><p>Maxfual can be positioned as a practical partner for fuel-heavy operations: install the right controls, capture accurate data at source, and turn it into decisions managers can act on.</p></div>
      ...
      <section id="contact" className="contact">
        <div><p className="eyebrow"><span></span>Ready for launch</p><h2>Demo lead form section</h2><p>This area can connect to WhatsApp, email, CRM, or a quote request form once the client confirms details.</p><ul><li><Phone/> +27 00 000 0000</li><li><Mail/> sales@maxfual.co.za</li><li><MapPin/> South Africa</li></ul></div>
    ...
    <footer><b>Maxfual</b><span>Demo website concept • Colours inspired by public MaxiFuel/industry references: deep navy, teal, white, charcoal.</span></footer>
  </>
}
